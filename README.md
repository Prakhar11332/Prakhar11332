...
```bash
$ whoami
> Prakhar — CS (AI specialization) student, Semester 5, Amrita Vishwa Vidyapeetham
> ID: CB.SC.U4AIE24366
...
```
No unexplained code makes it into a commit — every project I ship has documentation I wrote to teach my future self, not just to satisfy a rubric.
